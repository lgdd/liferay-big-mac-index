...
public class BigMacIndexExchangeRateProvider implements ExchangeRateProvider {
  ...
  public BigDecimal getExchangeRate(
    ...
    final Map<String, BigDecimal> rawIndexMap = _exchangeRateParser.toMap(
            csv);

    final String primaryCurrencyCode = StringUtil.toUpperCase(
            primaryCommerceCurrency.getCode());

    final String secondaryCurrencyCode = StringUtil.toUpperCase(
            secondaryCommerceCurrency.getCode());

    final BigDecimal rateToPrimary = rawIndexMap.get(primaryCurrencyCode);
    final BigDecimal rateToSecondary = rawIndexMap.get(
